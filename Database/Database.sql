...
go
		...
		values 
					('11wwe3','josue','MATANDIKO','GOMA',0975778463,'M','Goma',getDate()),
					('12wwe3','moses','KATORO','GOMA',0985574556,'M','Goma',getDate()),
					('13wwe3','HENRI','MASUKU','GOMA',0975778463,'M','Goma',getDate()),
					('14wwe3','tresor','KITWANDA','GOMA',0975778463,'M','Goma',getDate()),
					('15wwe3','eunice','bandu','GOMA',09854735,'M','Goma',getDate()),
					('16wwe3','josue','MATANDIKO','GOMA',0975778463,'M','Goma',getDate()),
					('72wwe3','josue','MATANDIKO','GOMA',0975778463,'M','Goma',getDate()),
					('18wwe3','josue','MATANDIKO','GOMA',0975778463,'M','Goma',getDate()),
					('19wwe3','josue','MATANDIKO','GOMA',0975778463,'M','Goma',getDate()),
					('132wwe3','josue','MATANDIKO','GOMA',0975778463,'M','Goma',getDate())
go
create procedure afficher_membre
as 
		select top 5 
			'matricule' as 'Numero Matrucule',
			'nom' as 'Nom',
			'postnom' as 'Postnom',
			'adresse' as 'Adresse',
			'phone' as 'Numero de Telephone',
			'sexe' as 'Genre',
			'lieuNaiss' as 'Lieu de Naissance',
			'dateNaiss' as 'Date de Naissance',
			'photo' as 'photo'
		from t_membre
		order by nom asc
go
...
as
			...
			'photo' as 'photo'
		from t_membre
		where matricule like'%'++'%' and nom like'%'+@nom+'%'
